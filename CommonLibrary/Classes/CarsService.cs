        ...
        public ICollection<Car> GetAllCars()
        {
            ...
            for (int index = 0; index < 1000; index++)
            {
                ...
                result.Add(new Car
                {
                    ...
                    ProductionDate = new DateTimeOffset(random.Next(2000, 2020), 
                        random.Next(1, 11), random.Next(1, 27), random.Next(1, 23), random.Next(1, 59), random.Next(0, 1), TimeSpan.Zero)
                });
            }
