...
namespace CommonLibrary.Classes
{
    public class DateTimeHelpers
    {
        ...
        public static string ShowPossibleTimeZones(DateTimeOffset offsetTime)
        {
            StringBuilder builder = new ();
            TimeSpan offset = offsetTime.Offset;

            builder.AppendLine($"{offsetTime} could belong to the following time zones:");
            ...
            foreach (TimeZoneInfo timeZone in timeZones)
            {
                ...
                {
                    builder.AppendLine($"   {timeZone.DisplayName}");
                }
            }
